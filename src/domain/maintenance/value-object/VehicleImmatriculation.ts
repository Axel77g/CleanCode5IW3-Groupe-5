...
export class VehicleImmatriculation {
    ...
    public static create(matriculation: string): VehicleImmatriculation | ApplicationException {
        const vehicleImmatriculation = new VehicleImmatriculation(matriculation);
